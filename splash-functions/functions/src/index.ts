...
export const buildIotaStakingRequest = functions.https.onRequest(
  async (request, response) => {
...
export const buildIotaUnstakingRequest = functions.https.onRequest(
  async (request, response) => {
    const client = new IotaClient({ url: request.body.rpc });
...
export const buildIotaTransaction = functions.https.onRequest(
  async (request, response) => {
    const client = new IotaClient({ url: request.body.rpc });
